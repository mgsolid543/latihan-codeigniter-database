...
<section class="content">
    ...
    <div class="box">
        <div class="box-body">
            ...
            if ($list_nilai == null) {
                $thn = $ci->ThnakadModel->get_by_id($id_thn_akad); // Memilih tahun akademik berdasarkan id
                ...
                <div class="alert alert-danger">
                    <strong>MAAF!</strong> tidak
                    matakuliah <?php echo $ci->MatakuliahModel->get_by_id($kode_matakuliah)->nama_matakuliah; ?> di
                    tahun ajaran <?php echo $thn->thn_akad . " (" . $tampilSemester . ")"; ?>
                </div>
                <?php
            } else {
                ?>
                <center>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Matakuliah</td>
                            <td> :
                                <?php echo $ci->MatakuliahModel->get_by_id($kode_matakuliah)->nama_matakuliah; ?></td>
                        </tr>
                        <tr>
                            <td>SKS</td>
                            <td> :
                                <?php echo $ci->MatakuliahModel->get_by_id($kode_matakuliah)->sks; ?></td>
                        </tr>
                        <?php
                        $thn = $ci->ThnakadModel->get_by_id($id_thn_akad); // Memilih tahun akademik berdasarkan id
