            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    $query = $this->db->query('SELECT id_thn_akad, semester, 
												   ...
												   FROM thnakad ORDER BY id_thn_akad DESC');
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_matakuliah" id="kode_matakuliah"
                               placeholder="Kode Matakuliah" value="<?php echo $kode_matakuliah; ?>"/>
                    </div>
                </div>

                <button type="submit" class="btn btn-primary">Proses</button>
            </form>
            <!--// Form Input Nilai Permatakuliah --><?php
