                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nama_panggilan" id="nama_panggilan"
                               placeholder="Nama Panggilan" value="<?php echo $nama_panggilan; ?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control" name="tgl_lahir"
                               value="<?php echo isset($tgl_lahir) ? set_value('tgl_lahir', date('Y-m-d', strtotime($tgl_lahir))) : set_value('tgl_lahir'); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        if ($photo == "") {
                            ...
                            ?>
                            <div>
                                <img src="<?php echo base_url() ?>upload_photo/mahasiswa/<?php echo $photo; ?>">
                            </div><br/>
                            <?php
                        }
                        ?>
