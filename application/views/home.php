...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="admin" class="logo">
            ...
            <span class="logo-mini"><b>STMIK</b>Jabar</span>
                ...
                <div class="box box-default color-palette-box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-sm-4 col-md-2">
                                <h4 class="text-center"><span class="info-box-text">Dosen</span></h4>

                                <div class="color-palette-set">
                                    <a href="<?php echo site_url('dosen') ?>"><center><i class="fa fa-user" style="font-size:48px;color:#3c8dbc"></i><center></a>
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
