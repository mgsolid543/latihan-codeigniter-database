...
class ThnakadModel extends CI_Model
{
    // Property yang bersifat public
    public $table = 'Thnakad';
    ...
    // Tabel data dengan nama thnakad
    function json()
    {
        ...
        $this->datatables->from('Thnakad');
        $this->datatables->add_column('action', anchor(site_url('thnakad/aktif_action/$1'), '<button type="button" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i></button>') . " " . anchor(site_url('thnakad/update/$1'), '<button type="button" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></button>') . "  " . anchor(site_url('thnakad/delete/$1'), '<button type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_thn_akad');
