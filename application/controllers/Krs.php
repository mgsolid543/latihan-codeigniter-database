...
class Krs extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('KrsModel'); // Memanggil KrsModel yang terdapat pada models
        $this->load->model('MahasiswaModel'); // Memanggil MahasiswaModel yang terdapat pada models
        $this->load->model('ProdiModel'); // Memanggil ProdiModel yang terdapat pada models
        $this->load->model('ThnakadModel'); // Memanggil ThnakadModel yang terdapat pada models
    ...
    public function krs_action()
    {
        ...
        // maka sistem akan menyimpan kedalam database
            ...
            if ($this->MahasiswaModel->get_by_id($nim) == null) {
            ...
            $data = array('action' => site_url('krs/daftar_krs_action'),
                ...
                'nama_lengkap' => $this->MahasiswaModel->get_by_id($nim)->nama_lengkap);
            ...
            $dataKrs = array(
                ...
                'nim' => $nim,
                'id_thn_akad' => $thn_akad,
                'thn_akad' => $this->ThnakadModel->get_by_id($thn_akad)->thn_akad,
                'semester' => $this->ThnakadModel->get_by_id($thn_akad)->semester == 1 ? 'Ganjil' : 'Genap',
                'nama_lengkap' => $this->MahasiswaModel->get_by_id($nim)->nama_lengkap,
                'prodi' => $this->ProdiModel->get_by_id(
                    $this->MahasiswaModel->get_by_id($nim)->id_prodi)->nama_prodi,
            );
    ...
    public function create($nim, $th)
    {
        ...
        $data = array(
            ...
            'thn_akad_smt' => $this->ThnakadModel->get_by_id($th)->thn_akad,
            'semester' => $this->ThnakadModel->get_by_id($th)->semester == 1 ? 'Ganjil' : 'Genap',
    ...
    public function create_action()
    {
        ...
        // maka sistem akan menyimpan kedalam database
            ...
            $dataKrs = array(
                ...
                'nim' => $nim,
                'id_thn_akad' => $id_thn_akad,
                'thn_akad' => $this->ThnakadModel->get_by_id($id_thn_akad)->thn_akad,
                'semester' => $this->ThnakadModel->get_by_id($id_thn_akad)->semester == 1 ? 'Ganjil' : 'Genap',
                'nama_lengkap' => $this->MahasiswaModel->get_by_id($nim)->nama_lengkap,
                'prodi' => $this->ProdiModel->get_by_id(
                    $this->MahasiswaModel->get_by_id($nim)->id_prodi)->nama_prodi,
            );
    ...
    public function update($id)
    {
        ...
        $row = $this->KrsModel->get_by_id($id);
        $th = $row->id_thn_akad;
    ...
    public function update_action()
    {
        ...
        // maka sistem akan melakukan update data KRS kedalam database
            ...
            $this->KrsModel->update($id_krs, $data);
    ...
    public function delete($id)
    {
        ...
        $row = $this->KrsModel->get_by_id($id);
        $nim = $this->KrsModel->get_by_id($id)->nim;
        $id_thn_akad = $this->KrsModel->get_by_id($id)->id_thn_akad;
