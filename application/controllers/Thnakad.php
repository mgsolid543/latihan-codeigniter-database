...
class Thnakad extends CI_Controller
{
	// Konstruktor	
    ...
    public function index(){
        ...
        $this->load->view('thnakad/thnakad_list'); // Menampilkan halaman tahun akademik
    ...
    public function create(){
        ...
        $data = array(
            'button' => 'Create',
			'back'   => site_url('Thnakad'),
            'action' => site_url('thnakad/create_action'),
        ...
        $this->load->view('thnakad/thnakad_form', $data); // Menampilkan halaman utama yaitu form tahun akademik semester
    ...
    public function create_action(){
		...
		// maka sistem akan menyimpan kedalam database
            ...
            $this->ThnakadModel->insert($data);
            $this->session->set_flashdata('message', 'Create Record Success');
            redirect(site_url('Thnakad'));
        }
    }
    ...
    public function update($id){
        ...
        $row = $this->ThnakadModel->get_by_id($id);
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
				'back'   => site_url('Thnakad'),
                'action' => site_url('thnakad/update_action'),
			...
			$this->load->view('header',$dataAdm ); // Menampilkan bagian header dan object data users
            $this->load->view('thnakad/thnakad_form', $data);  // Menampilkan form tahun akademik semester
			$this->load->view('footer'); // Menampilkan bagian footer
        } 
    ...
    public function update_action(){
		...
		'semester' => $this->input->post('semester',TRUE),
            ...
            $this->ThnakadModel->update($this->input->post('id_thn_akad', TRUE), $data);
    ...
    public function aktif_action($id){
		...
		$rows = $this->ThnakadModel->get_by_id($id);
			
		//jika id tahun akademik semester yang dipilih tersedia maka akan diaktifkan
		if ($rows) {	
				
			$this->ThnakadModel->update_tidakAktif($id);		
			
			$this->ThnakadModel->update_aktif($id);	
