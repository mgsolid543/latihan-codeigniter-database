...
class Jurusan extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('JurusanModel'); // Memanggil JurusanModel yang terdapat pada models
    ...
    public function json()
    {
        ...
        echo $this->JurusanModel->json(); // Menampilkan data json yang terdapat pada JurusanModel
    }
