...
class Dosen extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('DosenModel'); // Memanggil DosenModel yang terdapat pada models
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $config['upload_path'] = './upload_photo/dosen/';    //path folder image
    ...
    public function update_action()
    {
        ...
        // maka sistem akan melakukan update data mahasiswa kedalam database
            ...
            // Konfigurasi untuk melakukan upload photo
            $config['upload_path'] = './upload_photo/dosen/';    //path folder
            $config['allowed_types'] = 'jpg|png|jpeg'; //type yang dapat diupload jpg|png|jpeg
            $config['file_name'] = url_title($this->input->post('nidn')); //nama file photo dirubah menjadi nama berdasarkan nidn
            $this->upload->initialize($config);
            ...
            if (!empty($_FILES['photo']['name'])) {
                ...
                unlink("./upload_photo/dosen/" . $this->input->post('photo'));
                ...
                if ($this->upload->do_upload('photo')) {
                    ...
                    $this->DosenModel->update($this->input->post('id_dosen', TRUE), $data);
                }
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            unlink("./upload_photo/dosen/" . $row->photo);
