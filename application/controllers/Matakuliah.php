...
class Matakuliah extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('MatakuliahModel'); // Memanggil MatakuliahModel yang terdapat pada models
    ...
    public function json()
    {
        ...
        echo $this->MatakuliahModel->json();
    }
    ...
    public function update($id)
    {
        ...
        $row = $this->MatakuliahModel->get_by_id($id);
    ...
    public function update_action()
    {
        ...
        // maka sistem akan melakukan update data matakuliah kedalam database
            ...
            $this->MatakuliahModel->update($this->input->post('kode_matakuliah', TRUE), $data);
